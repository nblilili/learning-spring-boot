package com.spring.mybatisgenerator.mapper;
...
public interface CoffeeMapper {
     ...
     *
     * @mbg.generated Fri Jan 10 17:28:04 CST 2020
     */
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.spring.mybatisgenerator.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.spring.mybatisgenerator.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=com.spring.mybatisgenerator.handler.MoneyTypeHandler},",
